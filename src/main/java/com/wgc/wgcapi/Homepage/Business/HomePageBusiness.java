...
public class HomePageBusiness {
    ...
    public ResponseDto searchGuestBooks(HttpServletRequest getMember,Long limit ) {
        Member writerMember = memberService.getMemberInfo(getMember);
        List<GuestBook> guestBookList = homepageWriteService.searchGuestBooks(writerMember,limit);
